...
TEMP_OFFSET = 0.2               -- delta temperature when   

notif = tonumber(uservariables['notificationPorteOuverte']) - enable/disable notifications
...
if (notif == 1) then
    ...
    -- Compute since how long a 'state change' event was detected.
